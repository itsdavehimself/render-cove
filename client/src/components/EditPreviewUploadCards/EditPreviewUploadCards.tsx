import styles from './EditPreviewUploadCards.module.scss';
import ImageData from '../../types/ImageData';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faTrash } from '@fortawesome/free-solid-svg-icons';
import { useState, useEffect } from 'react';

interface EditPreviewUploadCardsProps {
...
const EditPreviewUploadCards: React.FC<EditPreviewUploadCardsProps> = ({
  existingImageArr,
  setExistingImageArr,
  existingImageData,
...
export default EditPreviewUploadCards;
